...
function buildThemeStyles(theme: PdfTemplateTheme): string {
  ...
  <style id="${THEME_STYLE_ID}">
    :root {
      ...
      --pdf-surface: ${theme.surfaceColor};
      ...
      --pdf-border: color-mix(in srgb, var(--pdf-accent) 18%, white);
      --pdf-shadow: 0 28px 80px rgba(15, 23, 42, 0.12);
    }
    ...
    * {
    ...
    .pdf-page {
      ...
      background:
        radial-gradient(circle at top right, color-mix(in srgb, var(--pdf-accent) 12%, white) 0%, transparent 34%),
    ...
    .hero {
      ...
      padding: 28px;
      background: linear-gradient(135deg, var(--pdf-accent) 0%, color-mix(in srgb, var(--pdf-accent) 60%, black) 100%);
      color: white;
    ...
    .panel {
      padding: 20px;
      background: linear-gradient(180deg, color-mix(in srgb, var(--pdf-surface) 48%, white) 0%, white 100%);
    }
    ...
    .week-head {
      ...
      background: linear-gradient(180deg, color-mix(in srgb, var(--pdf-surface) 60%, white) 0%, white 100%);
    ...
    .days-table td {
      padding: 12px 14px;
      border-bottom: 1px solid color-mix(in srgb, var(--pdf-border) 70%, white);
      text-align: left;
      vertical-align: top;
    }
    ...
    .tip-card {
      padding: 16px;
      background: linear-gradient(180deg, white 0%, color-mix(in srgb, var(--pdf-surface) 35%, white) 100%);
    }
...
function buildMinimalPreset(): string {
  return createDocument(`
    <section class="panel" style="padding: 0; overflow: hidden;">
      <div style="padding: 26px 28px 20px; background: linear-gradient(180deg, color-mix(in srgb, var(--pdf-surface) 75%, white) 0%, white 100%); border-bottom: 1px solid var(--pdf-border);">
