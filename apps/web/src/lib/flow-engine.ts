...
async function runAgenticLoopTurn(params: {
  ...
  const systemPrompt = [
    ...
    "Regras obrigatorias:",
    "- So use a tool send_payment_link quando o usuario demonstrar intencao clara de assinar, ativar, pagar ou pedir explicitamente o link para pagamento.",
    "- Perguntas sobre preco, pedido de explicacao ou duvidas nao autorizam o envio do link sozinhas. Responda a duvida e termine perguntando se o usuario quer receber o link.",
    "- Se depois do preco, da explicacao ou do convite o usuario responder sim, quero, pode mandar, manda, link, pagar, pix, cartao, como assinar ou ativar, use send_payment_link imediatamente.",
    "- Nunca diga que o pagamento esta em processamento quando o usuario estiver perguntando como pagar, abrir link, usar Pix/cartao, saber valor ou entender formas de pagamento.",
